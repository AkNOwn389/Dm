...
object VideoFeedGlobalSetter {
    fun setDeafaultReaction(holder: VideoFeedViewHolder, currentItem: VideoDataModels){
    ...
    fun afterReactionReasponse(holder: VideoFeedViewHolder, currentItem: LikesPostResponseModel, dataModel:VideoDataModels){
    ...
    fun iconSetterBaseOnLike(holder: VideoFeedViewHolder, currentItem: VideoDataModels) {
