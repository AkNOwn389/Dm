...
object NewsGlobalSetter {
    val TAG = "Global setter"
    fun setDefaultReaction(holder: NewsViewHolder, currentItem: NewsDataEntities) {
        when (currentItem.reactionType) {
            ReactionTypes.LIKE -> holder.likeBtn?.setCurrentImageResource(com.aknown389.dm.reactionTesting.FbReactions.reactions[0])
            ReactionTypes.LOVE -> holder.likeBtn?.setCurrentImageResource(com.aknown389.dm.reactionTesting.FbReactions.reactions[1])
            ReactionTypes.HAPPY -> holder.likeBtn?.setCurrentImageResource(com.aknown389.dm.reactionTesting.FbReactions.reactions[2])
            ReactionTypes.AMAZE -> holder.likeBtn?.setCurrentImageResource(com.aknown389.dm.reactionTesting.FbReactions.reactions[3])
            ReactionTypes.SAD -> holder.likeBtn?.setCurrentImageResource(com.aknown389.dm.reactionTesting.FbReactions.reactions[4])
            ReactionTypes.ANGRY -> holder.likeBtn?.setCurrentImageResource(com.aknown389.dm.reactionTesting.FbReactions.reactions[5])
        }
    }
    ...
    fun iconSetterBaseOnLike(holder: NewsViewHolder, currentItem: NewsDataEntities) {
