...
import com.aknown389.dm.pageView.homeFeed.utility.GlobalSetter.iconSetterBaseOnLike
...
class ChangeProfileView @Inject constructor(
    ...
    private fun setupLoader(
        ...
        try {
            ...
            holder.postImage!!.adjustViewBounds = true
